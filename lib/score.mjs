/* Diagnosis is computed here from the axis scores — never by the model.
   That guarantees one account always yields one diagnosis, which is the bug
   that made a competitor's report disagree with its own quiz ninety minutes later. */
...
export function buildReport(extraction, answers) {
  ...
  return {
    ...
    // Pillars come from the posts. The diagnosis name can never reach this
    // field — that is what put "The Invisible Expert" in a competitor's kit.
